...
\subsubsection{Classes vs.\ functions}
...
\subsubsection{Separate compilation vs.\ performance}
...
\subsubsection{Parametric vs.\ ad-hoc polymorphism}
...
\subsubsection{Modularity vs.\ large vocabularies}
...
\subsubsection{Eliminating vs.\ embracing tagged data}

\subsubsection{Data hiding vs.\ explicit memory layout}
