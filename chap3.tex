...
all the time.
Although we will not discuss it much, this approach is still
...
A ``domain'' in this theory is a partial order of sets of values that a
...
the order.
The advantage of this model, in essence, is that it provides a
...
%relationship between programs and domains
