...
% para: here we will discuss why it might be worth exploring
...
for many different kinds of elements. We will want to write code using
...
dynamic typing. The benefits are not absolute, but notational and semantic:
