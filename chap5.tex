...
\hline
Bidiagonal             &  Cholesky         &  GeneralizedSchur \\
Diagonal               &  CholeskyPivoted  &  LDLt \\
SymmetricRFP           &  QR               &  LU \\
TriangularRFP          &  QRCompactWY      &  CholeskyDenseRFP \\
Symmetric              &  QRPivoted & \\
Hermitian              &  QRPackedQ & \\
AbstractTriangular     &  QRPackedWYQ & \\
LowerTriangular        &  QRCompactWYQ & \\
UnitLowerTriangular    &  Hessenberg & \\
UpperTriangular        &  HessenbergQ & \\
UnitUpperTriangular    &  Eigen & \\
SymTridiagonal         &  GeneralizedEigen & \\
Tridiagonal            &  SVD & \\
UniformScaling         &  Schur & \\
\hline
\end{tabular}
\end{center}
...
% there are two uses: manual and automatic


% also embedding of bidiagonal in tridiagonal
