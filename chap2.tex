...
\textbf{Size} & \textbf{\# iter} & \textbf{NumPy} & \textbf{Julia} & \textbf{Julia dispatch} \\
\hline \hline
...
on a computer. Mathematicians can move instinctively between
...
you can do.
The data layouts used by static languages require a significant
