...
and itself. We also find that most uses of covariance and contravariance are more flexibly
...
Multiple dispatch has been formulated as dispatch on tuple types before (TODO cite).
...
The next major problem we need to solve arises from combining data-flow analysis
